        ...
        for method in route.methods:
            ...
            if method == "GET" and not path_params:
                ...
                lines.extend([
                    ...
                    f"    offset: int = Query(0, ge=0),",
                    f"    limit: int = Query(50, ge=1, le=200),",
                    f") -> dict[str, Any]:",
                ...
                lines.extend([
                    ...
                    f"    # TODO: Implement lookup",
                    f"    raise HTTPException(404, detail=\"Not found\")",
                    "",
                    "",
                ])
                ...
                lines.extend([
                    ...
                    f"    # TODO: Implement creation",
                    f"    return {{\"id\": \"placeholder\", \"status\": \"created\"}}",
                    "",
                    "",
                ])
                ...
                lines.extend([
                    ...
                    f"    # TODO: Implement update",
                    f"    return {{\"status\": \"updated\"}}",
                    "",
                    "",
                ])
